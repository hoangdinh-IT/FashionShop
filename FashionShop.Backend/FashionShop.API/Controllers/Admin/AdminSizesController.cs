...
namespace FashionShop.API.Controllers.Admin
{
    ...
    public class AdminSizesController : AdminBaseApiControllers
    {
        private readonly IAdminSizeService _sizeService;

        public AdminSizesController(IAdminSizeService sizeService)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetSizes([FromQuery] AdminSizeListRequest request)
        {
