...
import type { BrandFilters } from '../types/requests';
...
const BrandToolbar: React.FC<BrandToolbarProps> = ({ 
    ...
    const [filters, setFilters] = useState<BrandFilters>(defaultValues);
    ...
    const handleBooleanSelect = (key: keyof BrandFilters, value: any) => {
