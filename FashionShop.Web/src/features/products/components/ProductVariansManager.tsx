                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        {...register(`productVariants.${index}.sku` as const, { required: "Nhập SKU" })}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select 
                                    {...register(`productVariants.${index}.colorId` as const, { required: "Vui lòng chọn màu sắc" })}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select 
                                    {...register(`productVariants.${index}.sizeId` as const, { required: "Vui lòng chọn size" })}
                                    className={`w-full px-3 py-2.5 bg-slate-50 border rounded-lg text-sm text-slate-900 transition-colors outline-none cursor-pointer focus:bg-white focus:ring-4 focus:ring-blue-500/10
