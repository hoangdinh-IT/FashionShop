...
export const LoginForm: React.FC = () => {
    ...
    const fillDemoCredentials = () => {
        setValue("email", "demo@fashionshop.com");
    ...
    return (
        <div className="flex items-start justify-center gap-8 px-4">
            ...
            {/* === KHUNG DEMO CREDENTIALS === */}
            <motion.div
                initial={{ opacity: 0, x: 30 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }}
                className="hidden lg:block w-80 pt-12"
            >
                <div className="rounded-3xl border border-white/20 bg-white/5 p-6 backdrop-blur-md shadow-xl">
                    <div className="mb-5 flex items-center gap-3">
                        <div className="text-3xl">⚡</div>
                        <div>
                            <h3 className="text-lg font-semibold text-white">Tài khoản Demo</h3>
                            <p className="text-xs text-white/50">Nhấn để điền nhanh</p>
                        </div>
                    </div>

                    <div className="space-y-5 rounded-2xl bg-white/5 p-5 border border-white/10">
                        <div>
                            <p className="text-xs uppercase tracking-widest text-white/50 mb-1">Email</p>
                            <p className="font-mono text-sm text-white">demo@fashionshop.com</p>
                        </div>
                        <div>
                            <p className="text-xs uppercase tracking-widest text-white/50 mb-1">Mật khẩu</p>
                            <p className="font-mono text-sm text-white">123456</p>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="mt-6 w-full rounded-2xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 py-4 text-sm font-bold text-white transition-all hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center gap-2"
                    >
                        📋 Điền thông tin demo
                    </button>

                    <p className="mt-4 text-center text-[10px] text-white/40">
                        Dùng để test • Có thể thay đổi sau
                    </p>
                </div>
            </motion.div>
        </div>
