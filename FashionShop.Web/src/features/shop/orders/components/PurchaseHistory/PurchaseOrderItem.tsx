...
const PurchaseOrderItem: React.FC<Props> = ({ order, onCancelledOrder }) => {
    ...
    const groupedItems = order.orderItems?.reduce((acc, item) => {
        const brand = item.brandName || "Fashion Boutique"; // Fallback nếu không có brand
            ...
            <div className="bg-white rounded-[22px]">
                ...
                <div className="px-6 py-5 bg-slate-50/40 border-t border-slate-50 flex flex-col sm:flex-row gap-6 justify-between items-center">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="h-10 pl-5 pr-4 bg-slate-600 hover:bg-slate-800 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl transition-all duration-300 shadow-sm hover:shadow-indigo-100 active:scale-95 flex items-center gap-2 group/btn cursor-pointer">
                            Chi tiết
