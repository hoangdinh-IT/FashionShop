    ...
    return (
        <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-zinc-100">
            ...
            <div className="divide-y divide-zinc-100">
                {cartItems.map((item) => (
                    <div key={item.id} className="py-8 first:pt-0 last:pb-0 flex gap-6 group">
                        {/* Checkbox item */}
                        <div className="pt-2">
                            <input 
                                type="checkbox" 
                        ...
                        {/* Ảnh sản phẩm */}
                        <div className="w-28 h-36 bg-zinc-50 rounded-2xl overflow-hidden shrink-0 border border-zinc-100">
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                            <div className="flex justify-between items-start">
                                <div className="space-y-3">
                                    ...
                                    {/* NÚT MỞ DIALOG CẬP NHẬT BIẾN THỂ */}
                                    <button 
                                        onClick={() => handleOpenDialog(item)}
                                        className="group/variant flex items-center gap-2 bg-zinc-50 hover:bg-zinc-100 px-3 py-1.5 rounded-full text-[13px] text-zinc-600 border border-zinc-100 transition-all cursor-pointer"
                                    >
                            ...
                            <div className="flex justify-between items-end mt-4">
                                <div className="flex items-center border border-zinc-200 rounded-full p-1">
                                    <button 
