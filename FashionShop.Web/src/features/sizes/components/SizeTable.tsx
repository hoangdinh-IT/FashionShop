                            ...
                            data.map((item) => {
                                ...
                                return (
                                    <tr key={item.id} className="group hover:bg-indigo-50/40 transition-colors duration-200">
                                        ...
                                        {/* 1. INFO SIZE (Icon/Badge + Name) */}
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-4">
                                                <div className="w-12 h-12 rounded-xl shrink-0 border border-gray-200 bg-gray-50 flex items-center justify-center shadow-sm group-hover:shadow-md group-hover:border-indigo-200 group-hover:bg-white transition-all duration-300">
                                                    <span className="font-bold text-gray-600 text-lg group-hover:text-indigo-600 transition-colors">
                                                        {item.name}
                                                    </span>
                                                </div>
                                        ...
                                        <td className="px-6 py-5">
                                            <span className={`inline-block px-2.5 py-1 rounded-lg text-[11px] font-medium border ${typeInfo.color} transition-all`}>
                                                {typeInfo.label}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <div className="flex items-center justify-center gap-1.5 text-gray-500">
                                                <IoLayersOutline className="text-gray-400 text-sm" />
                                                <span className="font-mono font-semibold text-sm">{item.sortOrder}</span>
                                            </div>
                                        </td>
                                ...
                                <td colSpan={7} className="px-6 py-24 text-center">
                                    <div className="flex flex-col items-center justify-center gap-4">
                                        <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center shadow-sm border border-gray-100">
                                            <IoResizeOutline className="text-4xl text-gray-300" />
                                        </div>
                                        <div>
                                            <h3 className="text-gray-800 font-bold text-lg">Chưa có kích thước nào</h3>
