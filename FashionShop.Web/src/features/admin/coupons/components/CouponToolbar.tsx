...
import type { CouponFilters } from "../types/requests";
...
const CouponToolbar: React.FC<Props> = ({
    onSearch,
    onFilterChange
}) => {

    const defaultValues: CouponFilters = {
    ...
    const [filters, setFilters] = useState<CouponFilters>(defaultValues);
    ...
    const handleBooleanSelect = (key: keyof CouponFilters, value: string) => {
            ...
            <div className="p-2.5 flex gap-2.5 justify-between items-center bg-white relative z-10">
                <div className="relative w-full md:max-w-md group">
                    ...
                    <input
                        ...
                        placeholder="Tìm kiếm mã, tên coupon..."
                    />
                </div>
                    ...
                    >
                        <div className="p-3.5 md:p-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-1">Kho phiếu giảm giá</label>
                                    <select
