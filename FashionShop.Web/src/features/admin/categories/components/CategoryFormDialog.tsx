                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 font-sans">
                    ...
                    >
                        ...
                        >
                            ...
                            {/* --- PHẦN 2: BODY --- */}
                            <div className="p-8 overflow-y-auto custom-scrollbar grow bg-white">
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        ...
                                        <div className="group">
                                            ...
                                            <div className="relative">
                                                <select
                                                    {...register("parentId")}
                                                    className="w-full pl-5 pr-10 py-3 border border-transparent bg-gray-50 rounded-xl outline-none transition-all font-semibold text-gray-800 appearance-none cursor-pointer focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                                                >
                                                    <option value="" disabled hidden>-- Không có (Danh mục gốc) --</option>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows={4}
                                                className="w-full px-5 py-3 border border-transparent bg-gray-50 rounded-xl outline-none transition-all resize-none text-sm leading-relaxed placeholder:text-gray-400 text-gray-700 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                                        ...
                                        {initialData && (
                                            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 mt-1">Ẩn/Hiện danh mục này trên menu cửa hàng</p>
                                                </div>
                                    ...
                                    <div className="lg:col-span-1">
                                        <div className="sticky top-0">
                                            ...
                                            <div
                                                ...
                                                className="group relative w-full h-52 border-2 border-dashed border-gray-200 rounded-2xl hover:border-indigo-500 hover:bg-indigo-50/20 transition-all cursor-pointer flex flex-col items-center justify-center overflow-hidden bg-gray-50"
                                            >
                                                {previewUrl ? (
                                                    <>
                                                        <img 
                                                        ...
                                                        <div className="absolute inset-0 bg-gray-900/40 backdrop-blur-[1px] flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                                            ...
                                                            <span className="text-white font-semibold text-sm tracking-wide">Thay đổi ảnh</span>
                                                        </div>
                                                        <button
                                                            type="button"
                                                            onClick={(e) => {
                                                    ...
                                                    <div className="flex flex-col items-center text-center p-4">
                                                        <div className="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 text-indigo-500">
                                                            <IoImageOutline className="text-2xl" />
                                                        </div>
                                                        <p className="text-sm text-gray-700 font-semibold group-hover:text-indigo-600 transition-colors">Tải ảnh lên</p>
                            ...
                            {/* --- PHẦN 3: FOOTER --- */}
                            <div className="px-8 py-5 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3 shrink-0 relative z-20">
                                <button
                                    type='button'
                                    onClick={onClose}
