        ...
        <div className="h-full flex flex-col p-2.5 md:p-3 space-y-2.5 bg-gray-50/50">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-2.5 shrink-0">
                <div className="flex items-center justify-center w-full">
                    <h1 className="text-[26px] md:text-[28px] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600">
                        QUẢN LÝ ĐƠN HÀNG
                    </h1>
                </div>
            </div>
            ...
            {/* TABLE CONTAINER */}
            <div className="flex-1 flex flex-col min-h-0 bg-white rounded-[18px] shadow-sm border border-gray-200 overflow-hidden">
