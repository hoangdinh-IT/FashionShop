...
import type { Product, ProductDetail } from "../../features/admin/products/types/product";
import type { ProductQueryParams } from "../../features/admin/products/types/requests";
